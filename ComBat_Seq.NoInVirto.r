...
#Gather only non in vitro samples and those that are covid or non. 
metadata=metadata[(metadata$'covid status-curated' == 'covid' | metadata$'covid status-curated' == 'non') & metadata$'in vivo/in  vitro infected Curated' != "in vitro",]
